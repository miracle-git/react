...
创建 `./app/router/index.jsx` 文件，主要代码如下，详细的代码看源文件。
...
针对大型项目的**静态资源懒加载**问题，react-router 也给出了解决方案 —— [huge-apps](https://github.com/echenley/react-router-huge-apps-refactor)，它将 react-router 本身和 webpack 的 `require.ensure` 结合起来，就解决了这一问题。
